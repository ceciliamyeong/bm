#!/usr/bin/env python3
# GS variant: copies out_gs/<latest YYYY-MM-DD>/** → archive_gs/<same>/**; no index.html updates
import os, shutil, re
...
def update_index(latest_dir: Path):
    # GS variant: no index.html updates; pages will read from /indices
    print("[skip] index.html update skipped (GS variant)")
