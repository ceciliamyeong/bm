# Create a fully-checked bm20_daily.py implementing:
# - BASE_DATE_STR default 2024-01-01 (env override)
# - Option A: exclude coins from base only (returns base_val, excluded)
# - Yahoo v7 quote with v8 chart fallback; Toncoin mapping fixed
# - Safe _yf_price_on_date with range=max + first-available fallback
# - Best/Worst computation via iterrows to avoid float attribute issue
# - News text references BASE_DATE_STR dynamically
# - Outputs JSON/CSV/TXT/PNG (PDF optional if reportlab available)

from pathlib import Path

code = r'''# ===================== BM20 Daily (Yahoo-safe, 2025-08) =====================
...
out_path = "/mnt/data/bm20_daily_2024base.py"
