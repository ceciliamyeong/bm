# ===================== BM20 Daily (GS Variant) — Stable, Rebased Index, Editorial News =====================
# NOTE: Default OUT_DIR changed to 'out_gs' to avoid collision with main pipeline.
# 기능 요약:
...
# ================== 공통 설정 ==================
OUT_DIR = Path(os.getenv("OUT_DIR", "out_gs"))
